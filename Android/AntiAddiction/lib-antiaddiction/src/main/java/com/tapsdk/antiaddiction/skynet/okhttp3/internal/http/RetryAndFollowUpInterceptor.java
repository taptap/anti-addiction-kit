...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.RealInterceptorChain realChain = (RealInterceptorChain) chain;
    ...
    private Request followUpRequest(Response userResponse, Route route) throws IOException {
        ...
        switch (responseCode) {
            ...
            case HTTP_SEE_OTHER:
                ...
                if (com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.HttpMethod.permitsRequestBody(method)) {
                    final boolean maintainBody = com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.HttpMethod.redirectsWithBody(method);
