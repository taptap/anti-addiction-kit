...
import com.tapsdk.antiaddiction.skynet.okhttp3.Challenge;
...
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.StatusLine.HTTP_PERM_REDIRECT;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.StatusLine.HTTP_TEMP_REDIRECT;
...
public final class Response implements Closeable {
    final com.tapsdk.antiaddiction.skynet.okhttp3.Request request;
    final com.tapsdk.antiaddiction.skynet.okhttp3.Protocol protocol;
    final int code;
    final String message;
    final com.tapsdk.antiaddiction.skynet.okhttp3.Handshake handshake;
    ...
    private volatile com.tapsdk.antiaddiction.skynet.okhttp3.CacheControl cacheControl; // Lazily initialized.
     ...
     * </ul>
     */
    public com.tapsdk.antiaddiction.skynet.okhttp3.Request request() {
        return request;
    }

    /**
     * Returns the HTTP protocol, such as {@link com.tapsdk.antiaddiction.skynet.okhttp3.Protocol#HTTP_1_1} or {@link com.tapsdk.antiaddiction.skynet.okhttp3.Protocol#HTTP_1_0}.
     */
    public com.tapsdk.antiaddiction.skynet.okhttp3.Protocol protocol() {
        return protocol;
    }
     ...
     */
    public com.tapsdk.antiaddiction.skynet.okhttp3.Handshake handshake() {
        return handshake;
    }
     ...
     */
    public com.tapsdk.antiaddiction.skynet.okhttp3.CacheControl cacheControl() {
        com.tapsdk.antiaddiction.skynet.okhttp3.CacheControl result = cacheControl;
    ...
    public static class Builder {
        com.tapsdk.antiaddiction.skynet.okhttp3.Request request;
        com.tapsdk.antiaddiction.skynet.okhttp3.Protocol protocol;
        int code = -1;
        String message;
        com.tapsdk.antiaddiction.skynet.okhttp3.Handshake handshake;
        com.tapsdk.antiaddiction.skynet.okhttp3.Headers.Builder headers;
        ResponseBody body;
        ...
        public Builder() {
            headers = new com.tapsdk.antiaddiction.skynet.okhttp3.Headers.Builder();
        }
