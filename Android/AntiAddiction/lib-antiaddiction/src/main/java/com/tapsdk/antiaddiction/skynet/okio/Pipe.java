...
import com.tapsdk.antiaddiction.skynet.okio.PushableTimeout;
...
public final class Pipe {
    ...
    final com.tapsdk.antiaddiction.skynet.okio.Buffer buffer = new com.tapsdk.antiaddiction.skynet.okio.Buffer();
    boolean sinkClosed;
    ...
    public void fold(Sink sink) throws IOException {
        while (true) {
            ...
            com.tapsdk.antiaddiction.skynet.okio.Buffer sinkBuffer;
            synchronized (buffer) {
                ...
                closed = sinkClosed;
                sinkBuffer = new com.tapsdk.antiaddiction.skynet.okio.Buffer();
