...
import com.tapsdk.antiaddiction.skynet.okio.DeflaterSink;
...
public final class GzipSink implements Sink {
     ...
     */
    private final com.tapsdk.antiaddiction.skynet.okio.DeflaterSink deflaterSink;
    ...
    private void writeHeader() {
        ...
        com.tapsdk.antiaddiction.skynet.okio.Buffer buffer = this.sink.buffer();
