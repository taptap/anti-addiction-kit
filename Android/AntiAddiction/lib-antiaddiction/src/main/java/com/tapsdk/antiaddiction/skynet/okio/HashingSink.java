...
public final class HashingSink extends ForwardingSink {
     ...
     */
    public static HashingSink hmacSha1(Sink sink, com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
     ...
     */
    public static HashingSink hmacSha256(Sink sink, com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
     ...
     */
    public static HashingSink hmacSha512(Sink sink, com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
    ...
    private HashingSink(Sink sink, com.tapsdk.antiaddiction.skynet.okio.ByteString key, String algorithm) {
        super(sink);
        try {
     ...
     */
    public final com.tapsdk.antiaddiction.skynet.okio.ByteString hash() {
