...
public final class Route {
    final com.tapsdk.antiaddiction.skynet.okhttp3.Address address;
    final Proxy proxy;
    final InetSocketAddress inetSocketAddress;

    public Route(com.tapsdk.antiaddiction.skynet.okhttp3.Address address, Proxy proxy, InetSocketAddress inetSocketAddress) {
        if (address == null) {
    ...
    public com.tapsdk.antiaddiction.skynet.okhttp3.Address address() {
        return address;
    }
