...
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_NONE;
...
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.illegalArgument;
...
final class Http2Writer implements Closeable {
    ...
    final com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Hpack.Writer hpackWriter;

    Http2Writer(BufferedSink sink, boolean client) {
        this.sink = sink;
        this.client = client;
        this.hpackBuffer = new Buffer();
        this.hpackWriter = new com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Hpack.Writer(hpackBuffer);
    ...
    public synchronized void pushPromise(int streamId, int promisedStreamId,
                                         List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> requestHeaders) throws IOException {
        if (closed) throw new IOException("closed");
    ...
    public synchronized void synStream(boolean outFinished, int streamId,
                                       int associatedStreamId, List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> headerBlock) throws IOException {
        if (closed) throw new IOException("closed");
        headers(outFinished, streamId, headerBlock);
    }

    public synchronized void synReply(boolean outFinished, int streamId,
                                      List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> headerBlock) throws IOException {
        if (closed) throw new IOException("closed");
        headers(outFinished, streamId, headerBlock);
    }

    public synchronized void headers(int streamId, List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> headerBlock)
            throws IOException {
        if (closed) throw new IOException("closed");
        headers(false, streamId, headerBlock);
    }

    public synchronized void rstStream(int streamId, com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode)
            throws IOException {
        if (closed) throw new IOException("closed");
