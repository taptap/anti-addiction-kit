...
public final class Handshake {
    ...
    private final com.tapsdk.antiaddiction.skynet.okhttp3.CipherSuite cipherSuite;
    private final List<Certificate> peerCertificates;
    private final List<Certificate> localCertificates;

    private Handshake(TlsVersion tlsVersion, com.tapsdk.antiaddiction.skynet.okhttp3.CipherSuite cipherSuite,
    ...
    public static Handshake get(SSLSession session) throws IOException {
        ...
        com.tapsdk.antiaddiction.skynet.okhttp3.CipherSuite cipherSuite = com.tapsdk.antiaddiction.skynet.okhttp3.CipherSuite.forJavaName(cipherSuiteString);
    ...
    public static Handshake get(TlsVersion tlsVersion, com.tapsdk.antiaddiction.skynet.okhttp3.CipherSuite cipherSuite,
                                List<Certificate> peerCertificates, List<Certificate> localCertificates) {
