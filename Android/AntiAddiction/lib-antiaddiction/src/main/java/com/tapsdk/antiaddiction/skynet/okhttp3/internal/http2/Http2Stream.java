...
public final class Http2Stream {
    ...
    final int id;
    final com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2Connection connection;
    ...
    private com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header.Listener headersListener;
     ...
     */
    com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode = null;

    Http2Stream(int id, com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2Connection connection, boolean outFinished, boolean inFinished,
                Headers headers) {
     ...
     * been closed.
     */
    public synchronized com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode getErrorCode() {
        return errorCode;
    }
     ...
     */
    public void writeHeaders(List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> responseHeaders, boolean out) throws IOException {
     ...
     * transmitted.
     */
    public void close(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode rstStatusCode) throws IOException {
     ...
     * immediately.
     */
    public void closeLater(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode) {
     ...
     */
    private boolean closeInternal(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode) {
     ...
     */
    void receiveHeaders(List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> headers) {
        assert (!Thread.holdsLock(Http2Stream.this));
        boolean open;
        synchronized (this) {
    ...
    synchronized void receiveRstStream(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode) {
        if (this.errorCode == null) {
            this.errorCode = errorCode;
            notifyAll();
        }
    ...
    public synchronized void setHeadersListener(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header.Listener headersListener) {
    ...
    private final class FramingSource implements Source {
        ...
        public long read(Buffer sink, long byteCount) throws IOException {
            ...
            while (true) {
                ...
                com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header.Listener headersListenerToNotify = null;
                long readBytesDelivered = -1;
                com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCodeToDeliver = null;
        ...
        void receive(BufferedSource in, long byteCount) throws IOException {
            ...
            while (byteCount > 0) {
                ...
                if (flowControlError) {
                    in.skip(byteCount);
                    closeLater(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode.FLOW_CONTROL_ERROR);
                    return;
                }
    ...
    void cancelStreamIfNecessary() throws IOException {
        ...
        if (cancel) {
            ...
            Http2Stream.this.close(com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode.CANCEL);
        } else if (!open) {
            connection.removeStream(id);
        }
    }
