 ...
 * {@link com.tapsdk.antiaddiction.skynet.okio.BufferedSource} which is both more efficient and more convenient. Use
 * {@link com.tapsdk.antiaddiction.skynet.okio.Okio#buffer(Source)} to wrap any source with a buffer.
 *
 * <p>Sources are easy to test: just use a {@link com.tapsdk.antiaddiction.skynet.okio.Buffer} in your tests, and
 ...
 * how many bytes they {@link com.tapsdk.antiaddiction.skynet.okio.BufferedSource#require require}.
 *
 ...
 *
 * <p>And source has a stronger {@code skip} method: {@link com.tapsdk.antiaddiction.skynet.okio.BufferedSource#skip}
