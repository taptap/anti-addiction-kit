...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    private final com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.HttpCodec httpCodec;
    ...
    public RealInterceptorChain(List<Interceptor> interceptors, StreamAllocation streamAllocation,
                                com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.HttpCodec httpCodec, RealConnection connection, int index, Request request, Call call,
    ...
    public com.tapsdk.antiaddiction.skynet.okhttp3.internal.http.HttpCodec httpStream() {
        return httpCodec;
    }
