...
public final class Response<T> {
    ...
    public static <T> Response<T> success(T body) {
        return success(body, new com.tapsdk.antiaddiction.skynet.okhttp3.Response.Builder() //
                .code(200)
                .message("OK")
     ...
     * body.
     */
    public static <T> Response<T> success(T body, com.tapsdk.antiaddiction.skynet.okhttp3.Response rawResponse) {
    ...
    public static <T> Response<T> error(int code, ResponseBody body) {
        ...
        return error(body, new com.tapsdk.antiaddiction.skynet.okhttp3.Response.Builder() //
                .code(code)
     ...
     */
    public static <T> Response<T> error(ResponseBody body, com.tapsdk.antiaddiction.skynet.okhttp3.Response rawResponse) {
    ...
    private Response(com.tapsdk.antiaddiction.skynet.okhttp3.Response rawResponse, T body,
