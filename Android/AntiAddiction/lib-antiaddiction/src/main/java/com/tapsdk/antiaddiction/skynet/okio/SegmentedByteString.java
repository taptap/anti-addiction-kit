...
import static com.tapsdk.antiaddiction.skynet.okio.Util.arrayRangeEquals;
import static com.tapsdk.antiaddiction.skynet.okio.Util.checkOffsetAndCount;
 ...
 */
final class SegmentedByteString extends com.tapsdk.antiaddiction.skynet.okio.ByteString {
    final transient byte[][] segments;
    final transient int[] directory;

    SegmentedByteString(com.tapsdk.antiaddiction.skynet.okio.Buffer buffer, int byteCount) {
        super(null);
        ...
        int offset = 0;
        int segmentCount = 0;
        for (com.tapsdk.antiaddiction.skynet.okio.Segment s = buffer.head; offset < byteCount; s = s.next) {
            if (s.limit == s.pos) {
    ...
    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString toAsciiLowercase() {
        return toByteString().toAsciiLowercase();
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString toAsciiUppercase() {
        return toByteString().toAsciiUppercase();
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString md5() {
        return toByteString().md5();
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString sha1() {
        return toByteString().sha1();
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString sha256() {
        return toByteString().sha256();
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString hmacSha1(com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
        return toByteString().hmacSha1(key);
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString hmacSha256(com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
    ...
    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString substring(int beginIndex) {
        return toByteString().substring(beginIndex);
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString substring(int beginIndex, int endIndex) {
    ...
    void write(Buffer buffer) {
        ...
        for (int s = 0, segmentCount = segments.length; s < segmentCount; s++) {
            int segmentPos = directory[segmentCount + s];
            int nextSegmentOffset = directory[s];
            com.tapsdk.antiaddiction.skynet.okio.Segment segment = new com.tapsdk.antiaddiction.skynet.okio.Segment(segments[s], segmentPos,
    ...
    public boolean rangeEquals(
            int offset, com.tapsdk.antiaddiction.skynet.okio.ByteString other, int otherOffset, int byteCount) {
     ...
     */
    private com.tapsdk.antiaddiction.skynet.okio.ByteString toByteString() {
        return new com.tapsdk.antiaddiction.skynet.okio.ByteString(toByteArray());
    }
    ...
    public boolean equals(Object o) {
        ...
        return o instanceof com.tapsdk.antiaddiction.skynet.okio.ByteString
                && ((com.tapsdk.antiaddiction.skynet.okio.ByteString) o).size() == size()
