...
import com.tapsdk.antiaddiction.skynet.okio.Options;
import com.tapsdk.antiaddiction.skynet.okio.PeekSource;
...
final class RealBufferedSource implements com.tapsdk.antiaddiction.skynet.okio.BufferedSource {
    ...
    @Override
    public com.tapsdk.antiaddiction.skynet.okio.Buffer getBuffer() {
        return buffer;
    }

    @Override
    public long read(com.tapsdk.antiaddiction.skynet.okio.Buffer sink, long byteCount) throws IOException {
    ...
    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString readByteString() throws IOException {
        buffer.writeAll(source);
        return buffer.readByteString();
    }

    @Override
    public com.tapsdk.antiaddiction.skynet.okio.ByteString readByteString(long byteCount) throws IOException {
        require(byteCount);
    ...
    @Override
    public void readFully(com.tapsdk.antiaddiction.skynet.okio.Buffer sink, long byteCount) throws IOException {
        try {
            require(byteCount);
        } catch (EOFException e) {
            // The underlying source is exhausted. Copy the bytes we got before rethrowing.
    ...
    public String readUtf8LineStrict(long limit) throws IOException {
        ...
        com.tapsdk.antiaddiction.skynet.okio.Buffer data = new Buffer();
    ...
    @Override
    public long indexOf(com.tapsdk.antiaddiction.skynet.okio.ByteString bytes) throws IOException {
        return indexOf(bytes, 0);
    }

    @Override
    public long indexOf(com.tapsdk.antiaddiction.skynet.okio.ByteString bytes, long fromIndex) throws IOException {
        if (closed) throw new IllegalStateException("closed");
    ...
    @Override
    public long indexOfElement(com.tapsdk.antiaddiction.skynet.okio.ByteString targetBytes) throws IOException {
        return indexOfElement(targetBytes, 0);
    }

    @Override
    public long indexOfElement(com.tapsdk.antiaddiction.skynet.okio.ByteString targetBytes, long fromIndex) throws IOException {
        if (closed) throw new IllegalStateException("closed");
    ...
    @Override
    public boolean rangeEquals(long offset, com.tapsdk.antiaddiction.skynet.okio.ByteString bytes) throws IOException {
    ...
    public BufferedSource peek() {
        return Okio.buffer(new com.tapsdk.antiaddiction.skynet.okio.PeekSource(this));
    }
