...
public final class LoggingEventListener extends EventListener {
  private final com.tapsdk.antiaddiction.skynet.logging.HttpLoggingInterceptor.Logger logger;
  private long startNs;

  private LoggingEventListener(com.tapsdk.antiaddiction.skynet.logging.HttpLoggingInterceptor.Logger logger) {
    this.logger = logger;
  }
  ...
  public static class Factory implements EventListener.Factory {
    ...
    public Factory() {
      this(com.tapsdk.antiaddiction.skynet.logging.HttpLoggingInterceptor.Logger.DEFAULT);
    }
