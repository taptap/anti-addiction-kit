...
final class Relay {
    ...
    public static Relay read(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, "rw");
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.cache2.FileOperator fileOperator = new com.tapsdk.antiaddiction.skynet.okhttp3.internal.cache2.FileOperator(randomAccessFile.getChannel());
    ...
    private void writeHeader(
        ...
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.cache2.FileOperator fileOperator = new com.tapsdk.antiaddiction.skynet.okhttp3.internal.cache2.FileOperator(file.getChannel());
    ...
    class RelaySource implements Source {
         ...
         */
        private com.tapsdk.antiaddiction.skynet.okhttp3.internal.cache2.FileOperator fileOperator = new com.tapsdk.antiaddiction.skynet.okhttp3.internal.cache2.FileOperator(file.getChannel());
