...
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.Util.format;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.CONNECTION_PREFACE;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_ACK;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_COMPRESSED;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_END_HEADERS;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_END_STREAM;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_PADDED;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.FLAG_PRIORITY;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.INITIAL_MAX_FRAME_SIZE;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_CONTINUATION;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_DATA;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_GOAWAY;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_HEADERS;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_PING;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_PRIORITY;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_PUSH_PROMISE;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_RST_STREAM;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_SETTINGS;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.TYPE_WINDOW_UPDATE;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.frameLog;
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2.ioException;
import static com.tapsdk.antiaddiction.skynet.okio.ByteString.EMPTY;
 ...
 * com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Http2#INITIAL_MAX_FRAME_SIZE}.
 */
final class Http2Reader implements Closeable {
    ...
    // Visible for testing.
    final com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Hpack.Reader hpackReader;
    ...
    Http2Reader(BufferedSource source, boolean client) {
        ...
        this.hpackReader = new com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Hpack.Reader(4096, continuation);
    }
    ...
    private void readHeaders(Handler handler, int length, byte flags, int streamId)
        ...
        List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> headerBlock = readHeaderBlock(length, padding, flags, streamId);

        handler.headers(endStream, streamId, -1, headerBlock);
    }

    private List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> readHeaderBlock(int length, short padding, byte flags, int streamId)
            throws IOException {
    ...
    private void readRstStream(Handler handler, int length, byte flags, int streamId)
        ...
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode = com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode.fromHttp2(errorCodeInt);
        if (errorCode == null) {
     ...
     * continuation frames as they are needed by {@link com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Hpack.Reader#readHeaders()}.
     */
    ...
    interface Handler {
        ...
        void rstStream(int streamId, com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode);
