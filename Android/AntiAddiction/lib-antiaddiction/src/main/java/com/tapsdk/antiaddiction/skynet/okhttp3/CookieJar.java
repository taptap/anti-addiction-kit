...
public interface CookieJar {
    ...
    CookieJar NO_COOKIES = new CookieJar() {
        @Override
        public void saveFromResponse(HttpUrl url, List<com.tapsdk.antiaddiction.skynet.okhttp3.Cookie> cookies) {
        }

        @Override
        public List<com.tapsdk.antiaddiction.skynet.okhttp3.Cookie> loadForRequest(HttpUrl url) {
     ...
     * cookies.
     */
    void saveFromResponse(HttpUrl url, List<com.tapsdk.antiaddiction.skynet.okhttp3.Cookie> cookies);
     ...
     * {@linkplain com.tapsdk.antiaddiction.skynet.okhttp3.Cookie#matches match} {@code url}.
     */
