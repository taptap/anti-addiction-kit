...
public interface PushObserver {
     ...
     *                       and {@code :path}.
     */
    boolean onRequest(int streamId, List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> requestHeaders);
     ...
     */
    boolean onHeaders(int streamId, List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> responseHeaders, boolean last);
     ...
     */
    void onReset(int streamId, com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.ErrorCode errorCode);

    PushObserver CANCEL = new PushObserver() {

        @Override
        public boolean onRequest(int streamId, List<com.tapsdk.antiaddiction.skynet.okhttp3.internal.http2.Header> requestHeaders) {
            return true;
        }
