...
import com.tapsdk.antiaddiction.reactor.Emitter;
...
public final class OnSubscribeCreate<T> implements Observable.OnSubscribe<T> {
    ...
    final Action1<com.tapsdk.antiaddiction.reactor.Emitter<T>> Emitter;
    ...
    public void call(Subscriber<? super T> t) {
        ...
        default: {
            emitter = new BufferEmitter<T>(t, 128);
            break;
        }
        }
    ...
    implements Emitter<T>, Producer, Subscription {
        ...
        public final void request(long n) {
            if (com.tapsdk.antiaddiction.reactor.operators.BackpressureUtils.validate(n)) {
                com.tapsdk.antiaddiction.reactor.operators.BackpressureUtils.getAndAddRequest(this, n);
                onRequested();
            }
        }
    ...
    static abstract class NoOverflowBaseEmitter<T> extends BaseEmitter<T> {
        ...
        public void onNext(T t) {
            ...
            if (get() != 0) {
                actual.onNext(t);
                com.tapsdk.antiaddiction.reactor.operators.BackpressureUtils.produced(this, 1);
            } else {
                onOverflow();
            }
        }
    ...
    static final class BufferEmitter<T> extends BaseEmitter<T> {
        ...
        public BufferEmitter(Subscriber<? super T> actual, int capacityHint) {
            super(actual);
            this.queue =  new SpscUnboundedAtomicArrayQueue<Object>(capacityHint);
            this.wip = new AtomicInteger();
        }

        @Override
        public void onNext(T t) {
            queue.offer(com.tapsdk.antiaddiction.reactor.operators.NotificationLite.next(t));
            drain();
        }
        ...
        void drain() {
            ...
            for (;;) {
                ...
                while (e != r) {
                    ...
                    a.onNext(com.tapsdk.antiaddiction.reactor.operators.NotificationLite.<T>getValue(o));
                ...
                if (e != 0) {
                    com.tapsdk.antiaddiction.reactor.operators.BackpressureUtils.produced(this, e);
                }
    ...
    static final class LatestEmitter<T> extends BaseEmitter<T> {
        ...
        @Override
        public void onNext(T t) {
            queue.set(com.tapsdk.antiaddiction.reactor.operators.NotificationLite.next(t));
            drain();
        }
