...
public final class HashingSource extends ForwardingSource {
     ...
     */
    public static HashingSource hmacSha1(Source source, com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
     ...
     */
    public static HashingSource hmacSha256(Source source, com.tapsdk.antiaddiction.skynet.okio.ByteString key) {
    ...
    private HashingSource(Source source, com.tapsdk.antiaddiction.skynet.okio.ByteString key, String algorithm) {
        super(source);
        try {
