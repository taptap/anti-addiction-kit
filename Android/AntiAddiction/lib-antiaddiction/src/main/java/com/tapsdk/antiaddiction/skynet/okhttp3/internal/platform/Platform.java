...
public class Platform {
    ...
    private static Platform findJvmPlatform() {
        ...
        Platform jdk9 = com.tapsdk.antiaddiction.skynet.okhttp3.internal.platform.Jdk9Platform.buildIfSupported();

        if (jdk9 != null) {
            return jdk9;
        }

        Platform jdkWithJettyBoot = com.tapsdk.antiaddiction.skynet.okhttp3.internal.platform.JdkWithJettyBootPlatform.buildIfSupported();
    ...
    private static Platform findAndroidPlatform() {
        Platform android10 = com.tapsdk.antiaddiction.skynet.okhttp3.internal.platform.Android10Platform.buildIfSupported();

        if (android10 != null) {
            return android10;
        }

        Platform android = com.tapsdk.antiaddiction.skynet.okhttp3.internal.platform.AndroidPlatform.buildIfSupported();
