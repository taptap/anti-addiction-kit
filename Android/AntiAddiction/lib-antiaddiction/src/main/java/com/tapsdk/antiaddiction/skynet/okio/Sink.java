 ...
 * {@link com.tapsdk.antiaddiction.skynet.okio.BufferedSink} which is both more efficient and more convenient. Use
 * {@link com.tapsdk.antiaddiction.skynet.okio.Okio#buffer(Sink)} to wrap any sink with a buffer.
 *
 * <p>Sinks are easy to test: just use a {@link com.tapsdk.antiaddiction.skynet.okio.Buffer} in your tests, and
