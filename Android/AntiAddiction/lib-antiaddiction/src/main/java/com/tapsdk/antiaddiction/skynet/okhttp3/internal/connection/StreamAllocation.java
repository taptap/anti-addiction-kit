...
import com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RouteSelector;
...
import static com.tapsdk.antiaddiction.skynet.okhttp3.internal.Util.closeQuietly;
...
public final class StreamAllocation {
    ...
    private com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RouteSelector.Selection routeSelection;
    private Route route;
    ...
    private final com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RouteSelector routeSelector;
    private int refusedStreamCount;
    private com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection connection;
    ...
    public HttpCodec newStream(
        ...
        try {
            com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection resultConnection = findHealthyConnection(connectTimeout, readTimeout,
     ...
     */
    private com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection findHealthyConnection(int connectTimeout, int readTimeout,
                                                                                               int writeTimeout, int pingIntervalMillis, boolean connectionRetryEnabled,
                                                                                               boolean doExtensiveHealthChecks) throws IOException {
        while (true) {
            com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection candidate = findConnection(connectTimeout, readTimeout, writeTimeout,
     ...
     */
    private com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection findConnection(int connectTimeout, int readTimeout, int writeTimeout,
                                                                                        int pingIntervalMillis, boolean connectionRetryEnabled) throws IOException {
        boolean foundPooledConnection = false;
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection result = null;
        ...
        synchronized (connectionPool) {
            ...
            if (!foundPooledConnection) {
                ...
                result = new com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection(connectionPool, selectedRoute);
    ...
    private Socket releaseIfNoNewStreams() {
        ...
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection allocatedConnection = this.connection;
    ...
    public synchronized com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection connection() {
        return connection;
    }
    ...
    public void cancel() {
        ...
        com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection connectionToCancel;
        synchronized (connectionPool) {
            canceled = true;
            codecToCancel = codec;
     ...
     */
    public void acquire(com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection connection, boolean reportedAcquired) {
        assert (Thread.holdsLock(connectionPool));
     ...
     */
    private void release(com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection connection) {
     ...
     * of the synchronized block. (We don't do I/O while synchronized on the connection pool.)
     */
    public Socket releaseAndAcquire(com.tapsdk.antiaddiction.skynet.okhttp3.internal.connection.RealConnection newConnection) {
        assert (Thread.holdsLock(connectionPool));
