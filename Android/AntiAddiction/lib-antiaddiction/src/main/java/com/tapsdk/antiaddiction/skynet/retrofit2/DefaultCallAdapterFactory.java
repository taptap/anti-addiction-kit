 ...
 */
final class DefaultCallAdapterFactory extends com.tapsdk.antiaddiction.skynet.retrofit2.CallAdapter.Factory {
    static final com.tapsdk.antiaddiction.skynet.retrofit2.CallAdapter.Factory INSTANCE = new DefaultCallAdapterFactory();
    ...
    public com.tapsdk.antiaddiction.skynet.retrofit2.CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        return new CallAdapter<Object, com.tapsdk.antiaddiction.skynet.retrofit2.Call<?>>() {
            ...
            @Override
            public com.tapsdk.antiaddiction.skynet.retrofit2.Call<Object> adapt(Call<Object> call) {
                return call;
            }
        };
    }
