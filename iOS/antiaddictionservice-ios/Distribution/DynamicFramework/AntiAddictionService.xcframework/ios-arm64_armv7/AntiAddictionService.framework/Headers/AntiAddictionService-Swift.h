...
/// 当前用户重新授权
+ (void)updateCurAccountWithToken:(NSString * _Nonnull)token;
/// 退出用户登录
+ (void)logout;
/// 获取用户类型
/// \param userId 用户 id
...
+ (void)stopTimeStatic;
+ (void)realNameAuthWithName:(NSString * _Nonnull)name idCard:(NSString * _Nonnull)idCard phone:(NSString * _Nonnull)phone completion:(void (^ _Nonnull)(BOOL, NSString * _Nonnull))completion;
